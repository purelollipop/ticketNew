<template>
    <div>
        <div class="baseTable">
            <div class="baseHeadDiv baseheaderClass">
...
<script>
    ...
    import table from '../otherSetting/tableButtonObj';
    let name = table.name
    export default {
        name,
        data(){
        ...
        //    获取并修改tableName
            getTableNameFun(){
                if(this.$store.state.tableNameArr[this.tableCloneName]){
                    this.urlObj = this.$store.state.tableNameArr[this.tableCloneName].urlObj;
                }
            }
        },
        components:{
